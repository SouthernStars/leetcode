...
[leetcode链接](https://leetcode.cn/problems/minimum-number-of-swaps-to-make-the-string-balanced/)

1、使字符串平衡的最小交换次数-CSDN博客
https://blog.csdn.net/Lucy_wzw/article/details/149149543

2、使字符串平衡的最小交换次数 - 归鸿唱晚 - 博客园
