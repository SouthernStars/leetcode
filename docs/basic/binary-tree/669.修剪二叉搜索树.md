# 669.修剪二叉搜索树
[leetcode 链接](https://leetcode.cn/problems/trim-a-binary-search-tree/description/)
...
func trimBST(root *TreeNode, low int, high int) *TreeNode {
    ...
    if root.Val < low {// 左子树均不符合
        return trimBST(root.Right, low, high)
    }
    if root.Val > high {// 右子树均不符合
